...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta name="twitter:image:src" content="https://avatars1.githubusercontent.com/u/772937?s=400&amp;v=4" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary" /><meta name="twitter:title" content="ryanpcmcquen/linuxTweaks" /><meta name="twitter:description" content=":penguin: A whole host of Linux tricks I have picked up over the years, in plain text. Some of them are even useful. - ryanpcmcquen/linuxTweaks" />
    <meta property="og:image" content="https://avatars1.githubusercontent.com/u/772937?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="ryanpcmcquen/linuxTweaks" /><meta property="og:url" content="https://github.com/ryanpcmcquen/linuxTweaks" /><meta property="og:description" content=":penguin: A whole host of Linux tricks I have picked up over the years, in plain text. Some of them are even useful. - ryanpcmcquen/linuxTweaks" />
...
<meta name="theme-color" content="#1e2327">
  ...
  <div class="container-lg d-lg-flex flex-items-center p-responsive">
    ...
    <a class="Header-link" href="/ryanpcmcquen">ryanpcmcquen</a>
    /
    <a class="Header-link" href="/ryanpcmcquen/linuxTweaks">linuxTweaks</a>
...
>
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-scope-type="Repository" data-scope-id="12793129" data-scoped-search-url="/ryanpcmcquen/linuxTweaks/search" data-unscoped-search-url="/search" action="/ryanpcmcquen/linuxTweaks/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-global-search d-none" role="option">
  ...
  <li>
    ...
    <a href="/ryanpcmcquen/linuxTweaks/network/members" class="social-count"
      ...
      <h1 class="public ">
    <svg class="octicon octicon-repo" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/></svg>
  <span class="author" itemprop="author"><a class="url fn" rel="author" data-hovercard-type="user" data-hovercard-url="/users/ryanpcmcquen/hovercard" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/ryanpcmcquen">ryanpcmcquen</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/ryanpcmcquen/linuxTweaks">linuxTweaks</a></strong>
...
<nav class="hx_reponav reponav js-repo-nav js-sidenav-container-pjax container-lg p-responsive d-none d-lg-block"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" aria-current="page" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /ryanpcmcquen/linuxTweaks" href="/ryanpcmcquen/linuxTweaks">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a itemprop="url" data-hotkey="g i" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /ryanpcmcquen/linuxTweaks/issues" href="/ryanpcmcquen/linuxTweaks/issues">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a data-hotkey="g p" data-skip-pjax="true" itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /ryanpcmcquen/linuxTweaks/pulls" href="/ryanpcmcquen/linuxTweaks/pulls">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /ryanpcmcquen/linuxTweaks/projects" href="/ryanpcmcquen/linuxTweaks/projects">
    ...
    <a data-skip-pjax="true" class="js-selected-navigation-item reponav-item" data-selected-links="security alerts policy code_scanning /ryanpcmcquen/linuxTweaks/security/advisories" href="/ryanpcmcquen/linuxTweaks/security/advisories">
      <div class="d-inline"><svg class="octicon octicon-shield" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 2l7-2 7 2v6.02C14 12.69 8.69 16 7 16c-1.69 0-7-3.31-7-7.98V2zm1 .75L7 1l6 1.75v5.268C13 12.104 8.449 15 7 15c-1.449 0-6-2.896-6-6.982V2.75zm1 .75L7 2v12c-1.207 0-5-2.482-5-5.985V3.5z"/></svg></div>
      Security
</a>
    <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse people /ryanpcmcquen/linuxTweaks/pulse" href="/ryanpcmcquen/linuxTweaks/pulse">
  ...
  <nav class="reponav js-reponav text-center no-wrap"
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a class="js-selected-navigation-item selected reponav-item" itemprop="url" aria-current="page" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /ryanpcmcquen/linuxTweaks" href="/ryanpcmcquen/linuxTweaks">
        <span itemprop="name">Code</span>
        <meta itemprop="position" content="1">
</a>    </span>

      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /ryanpcmcquen/linuxTweaks/issues" href="/ryanpcmcquen/linuxTweaks/issues">
          <span itemprop="name">Issues</span>
          <span class="Counter">0</span>
          <meta itemprop="position" content="2">
</a>      </span>
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /ryanpcmcquen/linuxTweaks/pulls" href="/ryanpcmcquen/linuxTweaks/pulls">
        <span itemprop="name">Pull requests</span>
        <span class="Counter">0</span>
      ...
      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /ryanpcmcquen/linuxTweaks/projects" href="/ryanpcmcquen/linuxTweaks/projects">
      ...
      <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="security alerts policy code_scanning /ryanpcmcquen/linuxTweaks/security/advisories" href="/ryanpcmcquen/linuxTweaks/security/advisories">
        <span itemprop="name">Security</span>
        <meta itemprop="position" content="6">
</a>
      <a class="js-selected-navigation-item reponav-item" data-selected-links="pulse /ryanpcmcquen/linuxTweaks/pulse" href="/ryanpcmcquen/linuxTweaks/pulse">
        Pulse
</a>
...
<div class="Box-header py-2 d-flex flex-column flex-shrink-0 flex-md-row flex-md-items-center">
  ...
  <div id="readme" class="Box-body readme blob js-code-block-container">
    <article class="markdown-body entry-content p-3 p-md-6" itemprop="text"><h1><a id="user-content-linuxtweaks" class="anchor" aria-hidden="true" href="#linuxtweaks"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>linuxTweaks</h1>
<p>A whole host of Linux tricks I have picked up over the years, in plain text format. Some of them are even useful.</p>
</article>
  </div>
